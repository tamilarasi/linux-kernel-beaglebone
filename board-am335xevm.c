...
static struct tca8418_keypad_platform_data am335x_tca8418_info = {
        ...
        .cols=10,
        .rep=0,
        .irq_is_gpio=1,//added by tamilarasi
};
...
static void spi0_init(int evm_id, int profile)
{
	...
	ARRAY_SIZE(bone_spi0_slave_info));//addedby tamilarasi and it's done from http://communistcode.co.uk/blog/blogPost.php?blogPostID=1
	return;
}
